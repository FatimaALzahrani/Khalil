...
public class SimilatyKatlog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_similaty_katlog);
        ...
        surahSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                Toast.makeText(SimilatyKatlog.this, from, Toast.LENGTH_SHORT).show();
    ...
    public void Start(View view) {
        Intent intent=new Intent(this,SimlartyPage.class);
